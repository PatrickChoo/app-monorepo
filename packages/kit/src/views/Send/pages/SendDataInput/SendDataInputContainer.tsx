...
function SendDataInputContainer() {
  ...
  const isQuickSelectNavigatingRef = useRef(false);
  const route =
  ...
  const disableAddressTypeSelector =
    'disableAddressTypeSelector' in route.params
      ? route.params.disableAddressTypeSelector
      : undefined;
  const showAddressTypeSelectorWhenDisabled =
    'showAddressTypeSelectorWhenDisabled' in route.params
      ? route.params.showAddressTypeSelectorWhenDisabled
      : undefined;
  const nft = nfts?.[0];
            ...
            <RecipientQuickSelect
              ...
              onSelect={({
                ...
                if (isFromAccount || isFromAddressBook) {
                  ...
                  if (isQuickSelectNavigatingRef.current) return;
                  isQuickSelectNavigatingRef.current = true;
                  void (async () => {
                    try {
                      const queryResult =
                      ...
                      isQuickSelectNavigatingRef.current = false;
                    }
                  })();
                } else {
