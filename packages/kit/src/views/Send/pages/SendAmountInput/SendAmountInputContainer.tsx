...
function SendAmountInputContainer() {
  ...
  const maxBalance = useMemo(() => {
    ...
    if (isLightningNetwork && lnUnit === ELightningUnit.BTC) {
      return new BigNumber(chainValueUtils.convertSatsToBtc(balance)).toFixed();
    }
  ...
  const [, setIsAmountInputFocused] = useState(false);
  ...
  // Keyboard shortcut: Enter = confirm (when input is not focused)
  useEffect(() => {
